...
public class AOKPtipWidget extends AppWidgetProvider {
    ...
    public RemoteViews buildUpdate(Context context) {
        ...
        pending = PendingIntent.getBroadcast(
            context, 0, bcast, PendingIntent.FLAG_UPDATE_CURRENT);
        updateViews.setOnClickPendingIntent(R.id.horny, pending);
        ...
        if (mMessage >= 0) {
            ...
            updateViews.setViewVisibility(R.id.tip_box, View.VISIBLE);
        } else {
            updateViews.setViewVisibility(R.id.tip_box, View.INVISIBLE);
        }

        updateViews.setImageViewResource(R.id.horny, mIconRes);
